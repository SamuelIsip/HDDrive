...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function cargar_funcioanlidades_task(dia_selec) {
        ...
        var mes_cal = parseInt(document.getElementById("mes").children[0].getAttribute("value")) < 10
    ...
    document
        ...
        let tk_title = document.getElementById("task_title")
            .value;
        ...
        if (tk_message != "" || tk_title != "") {
            ...
            xhr.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    // Notification
                    window.parent.document.getElementById("notification_task").className = "notification_on";
                    // Clear inputs
