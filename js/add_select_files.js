...
export function load_events_add_select() {
    ...
    function toggleCheckOptions() {
        ...
        for (let i = 0; i < check_list.length; i++) {
            if (check_list[i].style.display === "none") {
                ...
                $(".files__add__select ul li:nth-child(5)").css("display", "inline-block");
                $(".files__add__select ul li:nth-child(6)").css("display", "inline-block");
                $(".files__add__select ul li:nth-child(7)").css("display", "inline-block");
            }
            else {
    ...
    function addToFavouriteFiles(json_arr) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch("./../api/addfavorite.php", {
                method: "POST",
                cache: "no-cache",
    ...
    function deleteSelectFile(files_data) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch("./../api/deletefile.php", {
                method: "POST",
                cache: "no-cache",
                headers: { "Content-Type": "application/json" },
                body: files_data,
